...
import { d1, d1Ease, LetterReveal } from '@/components/designOne/shared';

const SLIDE_DURATION_MS = 6000;

/**
 * Design-2 hero — a copy of the design-1 hero (auto-sliding backdrop,
 * letter-reveal display type, caption + progress indicators, parallax
 * scroll-out), offset below the site's global navbar instead of the
 * design-1 navbar.
 */
const slides = [
  {
...
export function D2Hero() {
  ...
  return (
    <section
      ref={ref}
      className="bg-[#0a0a0a] pt-[68px] sm:pt-[88px] lg:pt-[116px]"
    >
      {/* Image and content begin below the global navbar; hero fits the screen exactly */}
      <div className="relative flex h-[calc(100svh-68px)] min-h-[34rem] flex-col justify-end overflow-hidden sm:h-[calc(100svh-88px)] lg:h-[calc(100svh-116px)]">
