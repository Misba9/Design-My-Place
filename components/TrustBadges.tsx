  ...
  return (
    <section className="section-y-sm bg-luxury-black border-y border-white/5">
      <div className="container-site">
        <Stagger className="grid grid-cols-1 xs:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 mb-8 sm:mb-12">
          {badges.map(({ icon: Icon, label, sub }) => (
            <StaggerItem key={label} className="text-center sm:text-left">
        ...
        {showStats && (
          <AnimatedSection
            delay={0.15}
            className="flex flex-wrap justify-center items-center gap-6 sm:gap-8 lg:gap-16 pt-6 sm:pt-8 border-t border-white/5"
          >
